...
function TechCards() {
  ...
  return (
    <div className='mt-20'>
        <h2 className='text-center text-4xl font-bold'> Skills That Make It Happen </h2>
        <div className='mt-8 flex flex-wrap flex-col sm:flex-row gap-3 justify-evenly'>
            <TechCard 
                ...
                image={
                    <>
                        <div class="flex items-center gap-2 h-12">
                            ...
                            <b class="text-white text-xl">React</b>
                        </div>
                    </>
                }
            ...
            <TechCard 
                cardClassName="!from-[#20232a] !via-[#20232a] !to-[#06bcee] text-white shadow-[#06bcee]" // React Native's cyan
                image={
                    <>
                        <div class="flex items-center gap-2 h-12">
                            <img src={reactImage} className='h-10'/>
                            <b class="text-white">React Native</b>
                        </div>
                    </>
                }
